...
mod test {
    ...
    fn test_multipar_mha() {
        ...
        let mut outer_scat1 = Scatter::new(qi_out_ref_receiver);
        let mut outer_scat2 = Scatter::new(ki_out_ref_receiver);
        let mut outer_scat3 = Scatter::new(vi_out_ref_receiver);
        let mut outer_scat4 = Scatter::new(qi_out_crd_receiver);
        ...
        for _ in 0..outer_par {
            ...
            outer_scat4.add_target(chunk_qi_crd_sender1);
            ...
            let intersecti_data = CrdJoinerData::<u32, u32> {
                ...
                in_crd2: chunk_qi_crd_receiver1,
                in_ref2: chunk_qi_ref_receiver1,
            ...
            for _ in 0..par_factor {
                ...
                let kl_rdscanner =
                    CompressedCrdRdScan::new(kl_data, k1_seg.clone(), k1_crd.clone());
                ...
                let vl_rdscanner =
                    CompressedCrdRdScan::new(vl_data, v1_seg.clone(), v1_crd.clone());
                ...
                let vm_rdscanner =
                    CompressedCrdRdScan::new(vm_data, v3_seg.clone(), v3_crd.clone());
                ...
                let km_rdscanner =
                    CompressedCrdRdScan::new(km_data, k3_seg.clone(), k3_crd.clone());
                ...
                let qm_rdscanner =
                    CompressedCrdRdScan::new(qm_data, q3_seg.clone(), q3_crd.clone());
                ...
                let (drop_out_icrd_sender, drop_out_icrd_receiver) =
                    parent.bounded(softmax_chan_size);
        ...
        parent.add_child(outer_scat3);
        parent.add_child(outer_scat4);
        parent.add_child(outer_scat5);
        parent.add_child(outer_scat6);
        parent.add_child(outer_gat1);
        parent.add_child(outer_gat2);
        parent.add_child(outer_gat3);
        parent.add_child(outer_gat4);
        parent.add_child(outer_gat5);

        // fiberwrite_X0
        let x0_wrscanner = CompressedWrScan::new(out_final_intersecti2_receiver);
        parent.add_child(x0_wrscanner);

        // fiberwrite_X1
        let x1_wrscanner = CompressedWrScan::new(out_final_qk_out_crd_receiver);
        parent.add_child(x1_wrscanner);

        // fiberwrite_X2
        let x2_wrscanner = CompressedWrScan::new(out_final_intersectj3_receiver);
