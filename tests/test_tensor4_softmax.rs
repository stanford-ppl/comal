...
fn test_softmax() {
    ...
    let (bc1_bl_out_ref_sender, bc1_bl_out_ref_receiver) = parent.unbounded::<Token<u32, u32>>();
    let (bc2_bl_out_ref_sender, _bc2_bl_out_ref_receiver) = parent.unbounded::<Token<u32, u32>>();
