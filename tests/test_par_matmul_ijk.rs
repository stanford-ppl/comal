...
fn test_par_matmul_ijk() {
    ...
    let (intersectk_out_ref1_sender1, intersectk_out_ref1_receiver1) = parent.bounded(chan_size);
    let (intersectk_out_ref2_sender1, intersectk_out_ref2_receiver1) = parent.bounded(chan_size);
    ...
    let (intersectk_out_ref1_sender2, intersectk_out_ref1_receiver2) = parent.bounded(chan_size);
    let (intersectk_out_ref2_sender2, intersectk_out_ref2_receiver2) = parent.bounded(chan_size);
    ...
    let (intersectk_out_ref1_sender3, intersectk_out_ref1_receiver3) = parent.bounded(chan_size);
    let (intersectk_out_ref2_sender3, intersectk_out_ref2_receiver3) = parent.bounded(chan_size);
