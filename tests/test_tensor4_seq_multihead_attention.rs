...
fn test_multihead_attention() {
    ...
    let (bc_intersectm_out_crd_sender, bc_intersectm_out_crd_receiver) = parent.bounded(chan_size);
    ...
    let (intersectm2_out_ref2_sender, intersectm2_out_ref2_receiver) = parent.bounded(chan_size);
