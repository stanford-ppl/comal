...
fn test_spmm_sd_ijk_gcn(base_path: &PathBuf) {
...
#[test]
fn test_spmm_sd_ijk_looper() {
    let filename = env::current_dir().unwrap().join("tests/spmm_sd.toml");
