...
// Implement Serialize for Tensor to satisfy dam logging requirements
impl<'a, ValType: DAMType + Serialize, D: Dimension, const N: usize> Serialize for Tensor<'a, ValType, D, N> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        // Serialize as a flat vector of values for simplicity
